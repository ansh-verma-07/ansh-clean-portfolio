					...
					<div className="w-full border-t border-black">
						<div className="w-[80%] sm:w-full xm:w-full sub-heading font-normal padding-x font-NeueMontreal text-secondry padding-y grid gap-y-6">
							<p className="tracking-wider">
								A <span className="font-bold blend-target">full-stack developer</span> who enjoys building well-structured web applications and turning ideas into practical, user-friendly products.
							</p>
							<p className="tracking-wider">
								I like working across both the visual and functional sides of a project, collaborating with others, and learning through hands-on development. Outside of coding, I find inspiration in traveling, exploring new places, and continuously improving my craft. I’m fluent in <span className="font-bold blend-target">Hindi</span> and <span className="font-bold blend-target">English</span>, with conversational proficiency in <span className="font-bold blend-target">Chhattisgarhi</span>.
							</p>
						</div>
					</div>
				</div>
